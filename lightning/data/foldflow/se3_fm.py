...
from lightning.data.foldflow.rigid_helpers import (
    assemble_rigid_mat,
...
class SE3FlowMatcher:
    ...
    def forward_marginal(
        ...
        Args:
            ...
            t: continuous time in [0, one].
            flow_mask: [..., N] which residues to flow.
            as_tensor_7:
            rigids_1: [..., N] openfold Rigid objects at time t=one (noise).
    ...
    def reverse(
        ...
        """Reverse sampling function from (t) to (t-one).
